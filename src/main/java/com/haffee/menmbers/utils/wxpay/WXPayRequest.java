...
public class WXPayRequest {
     ...
     * @throws Exception
     */
    public String requestOnceSimple(final String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, String mch_id) throws Exception {
