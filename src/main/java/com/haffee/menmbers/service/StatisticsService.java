...
//
//    String getRechargeFeeTotal(int shopId);
//
//    String getConsumeFeeToday(int shopId);

//    List getConsumeFeeList(int shopId);
//
//    List getConsumeCountList(int shopId);
//
//    List getRechargeFeeList(int shopId);
